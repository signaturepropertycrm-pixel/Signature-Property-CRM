...
export function AddSalePropertyForm({ setDialogOpen, onSave, propertyToEdit, totalProperties }: AddSalePropertyFormProps) {
   ...
   useEffect(() => {
    if (propertyToEdit) {
        ...
        reset({
            ...
            road_size_ft: propertyToEdit.road_size_ft || null,
            potential_rent_amount: propertyToEdit.potential_rent_amount || null,
            front_ft: propertyToEdit.front_ft || null,
            length_ft: propertyToEdit.length_ft || null,
        });
    } else {
